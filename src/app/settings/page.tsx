                ...
                <Card>
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-4 p-4 rounded-lg bg-cream-dim">
                        <div className="flex items-center gap-4 flex-1 min-w-0">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-sm text-charcoal-muted truncate">{email}</p>
                          </div>
                        </div>
                        <span className="px-3 py-1 text-xs font-medium bg-green-100 text-green-700 rounded-full self-start sm:self-center flex-shrink-0">
                          Connected
                        </span>
                      </div>
                    </div>
